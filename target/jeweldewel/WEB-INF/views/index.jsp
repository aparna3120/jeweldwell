  ...
  <div class="row">
    <div class="col-sm-4">
      <a href="ProductDescription?id=101" class="thumbnail">
        <p>Rings</p>
        <img src="./resources/101.jpg" alt="Diamond Rings" style="width:230px;height:215px">
    ...
    <div class="col-sm-4">
      <a href="ProductDescription?id=104" class="thumbnail">
        <p>Ear Rings</p>
        <img src="./resources/104.jpg" alt="Diamond Ear Rings" style="width:230px;height:215px">
    ...
    <div class="col-sm-4">
      <a href="ProductDescription?id=106" class="thumbnail">
        <p>Necklace</p>
        <img src="./resources/106.jpg" alt="Diamond Necklace" style="width:230px;height:215px">
